      ...
      <%
         ...
         while(enu.hasMoreElements()){
            ...
            */
            ...
            // for - each loop와 map.Entry 를 사용해 Hashtable의 키-값 쌍을 반복처리
            // hCart.entrySet()은 Set을 반환하여 for-each loop 에서 사용한다
            // map.Entry : map 에 저장된 모든 키-값 쌍을 각각의 키-값을 갖고있는 하나의 객체를 얻는다
            // entry 라는 객체 변수는 HashMap 에 대한 키 값-쌍을 하나의 객체로 갖고있어
            // getkey(), getbalue() 메소드로 key와 value 에 접근이 가능하다.
