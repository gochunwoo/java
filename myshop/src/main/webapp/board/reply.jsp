<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    dto = boardManager.getReplyData(num);	// 해당 댓글의 원글에 대한 정보 읽기
    %>
<!DOCTYPE html>
<html>
<head>
	...
	<input type="hidden" name="nested" value="<%= dto.getNested()%>">
		<table border="1">
			...
			<tr>
				...
				<td><input name="title" style="width: 100%" value="[RE]<%= dto.getTitle().length() >= 4 ? dto.getTitle().substring(0,2) : dto.getTitle() %>
				"></td>
			</tr>
			<tr>
