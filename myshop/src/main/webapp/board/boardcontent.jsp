...
String apass = "*****";	// 일반사용자는 비밀번호 보이지 않기
String adminOk = (String)session.getAttribute("adminOk");	//세션에서 adminOK 라는 키의 값을 읽기
if(adminOk != null){
	if(adminOk.equals("admin")) apass = dto.getPass();	// 키 값이 admin 인 경우 비밀번호 저장
}
%>
...
<body>
	<table>
		<tr>
			...
			<td colspan="2" style="test-align: right">
